...
> **Rujukan silang:** `06_BEIYUAN.md`, `09_CULTIVATION_LAW_SYSTEM.md` §8.2, `10_ECONOMY_SYSTEM.md` §4.1 (jasa pengobatan), `22_SARANG_JIUYIN.md` (relasi rumit racun-obat)
...
- **Sarang Jiuyin** (`22_SARANG_JIUYIN.md`): relasi rumit — secara filosofi "musuh alami" (racun vs obat), tapi diam-diam saling menghormati keahlian, dengan riwayat pertukaran resep penawar tak resmi.
