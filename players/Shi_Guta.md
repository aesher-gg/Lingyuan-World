...
> **Rujukan silang:** `00_CORE_RULES_AI_GM.md` §1.6 & §1.10, `03_AZURE_MOUNTAIN_RANGE.md`, `20_DOJO_PAHAT_NAGA.md`
...
- Batu Keras — Fana, alat pemukul kecil/latihan.
- Panci Bambu Darurat — Fana, alat masak survival.
- Jimat Kertas Rusak — Fana/Mati, sudah dipelajari geometri garisnya.
- Kantong Air Kulit × 1 — Fana, terisi 30%.
- Perban Kain Katun Kotor — Fana, tidak terpakai.

**Teknik:**
- [Benih Insight: Postur Aliran Berat Tubuh] — Pencerahan diri dari survival di alam liar.
- [Benih Insight: Logika Garis Jimat] — Pencerahan dari meneliti Jimat Kertas Rusak.
- [Otot Memori: Efisiensi Pukulan Palu Batu] — Adaptasi dari mengamati Gang & Mandor Kui.
