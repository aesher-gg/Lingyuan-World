...
**Nama Karakter:** Ryxian
**Lokasi Awal:** Desa Chayun, Qingyu (lihat `03_QINGYU.md`)
**Realm & Stage Awal:** Mortal Foundation (Fondasi Fana) — Qi Cap: 0 (RealmBase v3.0 — lihat `09_CULTIVATION_LAW_SYSTEM.md` §9)
...
- Senjata: Tidak ada
- Zirah/Pelindung: Baju Desa Sederhana — Fan-Grade, pakaian kain lusuh
- Aksesoris: Tidak ada

**Inventory Awal (dibawa, tidak terpakai):**
- Bekal Roti Kering & Buah Hutan × 2
- Kantong Air × 1
