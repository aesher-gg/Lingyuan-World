...
**Sekte/Afiliasi:** Sanxiu (Kultivator Pengembara / Liar)

**Kondisi:** HP 500/500 · Qi 600/2500 · Stamina 70/100 · Satiety 80% · Kondisi: Mengantuk Ringan, Otot Pulih · Karma: Merit +6 | Sin +6 (Condong ke Gelap)
...
- **Senjata:** Tongkat Bambu Giok Darah — Spirit-Grade, Tier 3 (Bermutasi dari Tier 2 setelah direndam darah & energi Ular Naga Gunung Tier 5).
- **Zirah/Pelindung:** Jubah Kultivator Hijau Gelap — Fan-Grade, Tier 2 (Kondisi: Robek di rusuk kiri, sedang dijemur).
- **Aksesoris:** Tidak ada

**Inventory & Base Storage (Markas):**
- Kantong Air Kulit (Penuh) & Batu Api Baja (Dibawa di tubuh)
- 🥩 Daging Ular Naga Asap ±140kg (Tier 5, Awet berbulan-bulan)
- 🍖 Daging Babi Bertanduk Asap (Bekal 6 hari, Tier 4)
- 🛡️ Sisik Perut Ular Naga x10 (Tier 4 Material)
- 🐆 Inti Bayangan Murni x1 (Tier 5 Core - Elemen Ilusi/Gelap)
- 🧥 Kulit Bayangan Utuh x1 (Tier 5 Material - Bahan zirah/jubah tingkat Dewa)
- 🦴 Taring & Cakar Bayangan (Tier 5 Material)

**Teknik & Dao:**
- 🗡️ **[Jurus Rahasia] Belahan Kehampaan Bambu Giok** (Offense - Memotong realitas/molekuler, mengabaikan pertahanan fisik).
- 🌿 **[Jurus Rahasia] Tunas Rhizome Giok** (Regenerasi - Menutup luka instan dengan membakar biomassa/kalori tubuh).
- 🌬️ **Langkah Meluncur Bambu Kosong** (Levitasi/Movement Core Formation).
- 🧠 **Pemahaman Dao Pasif:** Pemangkasan, Redirection (Pembelokan Gaya), Parasit (Penjajahan Energi), & Regenerasi.
