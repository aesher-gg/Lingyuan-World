...
> **Rujukan silang:** `00_CORE_RULES_AI_GM.md` §1.6 & §1.10, `02_CENTRAL_PLAINS.md`, `18_DOJO_GODAM_BESI.md`
...
**Sekte/Afiliasi:** Perguruan Tielu — Murid Magang / Murid Luar

**Kondisi:** HP 100/100 · Qi 0/0 · Stamina 100/100 · Satiety 90% · Kondisi Normal · Karma Netral

**Currency:**
- Tael Tembaga: 0 (Saku Luar)
- Tael Perak: 13 (Tersembunyi di bawah papan lantai Kamar 4 Asrama)
...
- Botol Kecil *Die Da Jiu* — Fan-Grade (Pribadi, sisa setengah)
- Roti Perjalanan (Hardtack) × 2.0 bungkus — Fan-Grade (Pribadi)
- Kantong Garam Kasar × 1 — Fan-Grade (Pribadi)
- Kantong Kecil Bubuk Cabai × 1 — Fan-Grade (Pribadi)

**Teknik Awal / Dipelajari:**
- **Pernapasan Besi Tua** (Dasar) — Sumber: Observasi mandiri dan penyesuaian intuitif selama kerja fisik di Perguruan Tielu.
- **Appraisal Logam Dasar** — Sumber: Diajarkan secara singkat oleh Xiao Chui (Murid Senior).
- **Keahlian Pasif:** Pengamatan Bahasa Tubuh Dasar, Penipuan Tingkat Rendah, *Sleight of Hand* (Teruji), *Finger Dexterity* (Meningkat).
