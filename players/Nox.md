...
**Nama Karakter:** Nox
**Lokasi Awal:** Perguruan Luohua (Desa Qingmu), Tianzhou *(lihat `02_TIANZHOU.md` & `17_PERGURUAN_LUOHUA.md`)*
...
- Kantong Air Kulit (Fan-Grade) — Terisi penuh, perlengkapan standar
- Batu Api & Serabut Kering (Fan-Grade) — Alat latihan kontrol mikro & barometer stabilitas (Teruji 17x konsisten)
- Sabit Berkarat (Fan-Grade) — Tersedia kembali setelah hukuman berakhir, belum diambil
- Gulungan Dasar Meridian (Fan-Grade) — Sumber teori fondasi, hadiah dari Ah Jian
- Panduan Stabilisasi Dantian Awal (Fan-Grade) — Referensi historis masa stabilisasi, telah menyelesaikan fungsi utamanya
