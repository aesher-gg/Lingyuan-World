...
- **Lembah Tianlie** (perbatasan Tianzhou–Moyuan, 900 li dari Tianjing) — zona perang abadi ortodoks vs demonic, tanah tandus akibat pertempuran ratusan tahun. **Satu-satunya lokasi di dunia untuk Tribulasi Petir Agung (Realm 8→9)** — lihat `09_CULTIVATION_LAW_SYSTEM.md` §8.4.
- **Gunung Sanxuan** (perbatasan Tianzhou–Qingyun) — diklaim tumpang tindih 3 sekte; Benteng Heisha bersembunyi di lerengnya.
- **Sungai Canglan** (membentang 200–600 li dari Tianjing) — jalur dagang air utama provinsi, ramai siang hari, dipatroli milisi Serikat Delapan Penjuru, rawan bajak sungai di malam hari.
- **Kota Haoyang** (300 li dari Tianjing) — kota dagang terbesar kedua, gerbang menuju semua provinsi.
...
### Desa Qingmu (450 li dari Tianjing)
Desa pertanian damai, sering jadi titik awal kisah pendekar muda.

| NPC | Peran | Umur | Realm & Stage | Qi Cap | Teknik Andalan | Karakteristik & Sifat |
|---|---|---|---|---|---|---|
| Kepala Desa Wu Lao | Kepala Desa Qingmu | 70 | Non-Kultivator | — | Tidak bertarung — mengandalkan tongkat kayu sebagai alat jalan sekaligus pertahanan darurat | Bijaksana dan tenang, jarang marah, selalu jadi penengah damai tiap konflik warga |
...
### Desa Lingquan (380 li dari Tianjing)
...
| Kepala Desa Feng | Kepala Desa Lingquan | 58 | Non-Kultivator | — | Tidak bertarung | Tegas soal aturan sumur suci, bisa sangat keras jika ada yang melanggar kesuciannya |

### Desa Huolian (520 li dari Tianjing)
...
### 🆕 Kota Baru: Kota Tianhe (鳳陽城, "Kota Phoenix")
...
### 🌿 🆕 Hutan Wanmu (Hutan Wanmu — 650 li dari Tianjing)
...
*(Lihat juga Murid Senior Ah Jian di tabel Desa Qingmu di atas.)*

### 🔨 Perguruan Tielu (Desa Huolian)
Perguruan kecil pandai besi. Dipandang kasar dan tak elegan, tapi dihormati karena kejujuran dagangnya — tak pernah memihak dalam konflik sekte manapun. *(NPC: Tie Gang & Xiao Chui — lihat tabel Desa Huolian di atas.)*

---

## Aliansi Dagang & Organisasi

- **Serikat Dagang Delapan Penjuru** (Kota Haoyang) — federasi pedagang terbesar dunia, punya milisi & armada sendiri. Pragmatis, tak memihak faksi manapun selama transaksi lancar.
- **Biro Pengawalan Wan'an** (Kota Haoyang) — jasa pengawalan barang berharga. Sangat menjaga reputasi, kegagalan misi berarti aib turun-temurun.

### Bukit Yulan
*(Tianzhou, dekat Kota Haoyang, ±250 li dari Tianjing)*
...
### ⚔️ Benteng Heisha
*(lereng Gunung Sanxuan, ±150 li dari perbatasan Tianzhou)*
...
### ⚔️ Markas Bajak Sungai Canglan
*(bergerak sepanjang Sungai Canglan, 100–400 li dari Kota Haoyang)*

Tidak punya markas tetap — kelompok ini berpindah-pindah titik sepanjang aliran Sungai Canglan, menyerang kapal dagang kecil di malam hari lalu bersembunyi di anak sungai dangkal yang sulit dilacak kapal besar.
