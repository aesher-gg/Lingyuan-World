...
| Guru/Kepala Perguruan | Realm 3 | Li Xingchun — mengajar personal teknik rahasia perguruan |

## Anggota Kunci
| Nama | Peran | Catatan |
|---|---|---|
| Guru Li Xingchun | Kepala Perguruan | Foundation Establishment Puncak — detail lengkap di `02_TIANZHOU.md` |
| Murid Senior Ah Jian | Murid utama | Qi Refining Puncak, ambisius & suka pamer (lihat karakteristik di `02`) |
| 🆕 Jiang Ziling | Murid perguruan (contoh karakter pemain) | Foundation Establishment Menengah — lihat profil lengkap di `players.md` |

## Fasilitas
- Halaman latihan kecil di bawah pohon aprikot tua (asal nama perguruan)
...
|---|---|---|
| 🆕 Pedang Leluhur Perguruan | Tier 2, Huang-Grade | Pedang pendiri perguruan, dipajang & dipakai hanya untuk upacara penerimaan murid baru — bukan senjata tempur aktif |
