...
> **Rujukan silang:** `04_MOYUAN.md`, `09_CULTIVATION_LAW_SYSTEM.md` §8.2 & §8.3, `33_PERKUMPULAN_WUYING.md` (rival profesional)
...
| Sistem Titik Kontak | Kontrak disampaikan lewat perantara/dead-drop, mirip tapi lebih longgar dari sistem token Perkumpulan Wuying (`33_PERKUMPULAN_WUYING.md`) | Semua anggota |
...
- **Perkumpulan Wuying** (`33_PERKUMPULAN_WUYING.md`): rival profesional utama — bukan permusuhan terbuka, lebih ke persaingan pasar kontrak. Beberapa klien sengaja membandingkan tawaran dari kedua organisasi.
- **Sekte Xuanyuan** (`15_SEKTE_XUANYUAN.md`): rumor lama menyebut ada "saluran belakang" tak resmi untuk pekerjaan politik sensitif, tak pernah dikonfirmasi kedua pihak.
- **Kultus Qisha** (`23_KULTUS_QISHA.md`): ditolak tegas sebagai mitra kerja — dianggap terlalu tidak bisa dipercaya bahkan untuk standar dunia hitam.
